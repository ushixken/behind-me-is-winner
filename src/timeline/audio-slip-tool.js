  ...
  class AudioSlipTool {
    constructor() {
      ...
      this.button.innerHTML =
        '<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M3 3v10M13 3v10M1.5 8h13M1.5 8l2.5-2.5M1.5 8 4 10.5M14.5 8 12 5.5M14.5 8 12 10.5"/></svg>';
    ...
    onPointerDown(event) {
      ...
      this.drag = {
        ...
        maxOffset: Math.max(
          -clip.sourceStart,
          clip.sourceDuration - clip.sourceEnd,
        ),
      };
    ...
    onDrag = (event) => {
      ...
      drag.offset = Math.max(
        drag.minOffset,
        Math.min(drag.maxOffset, drag.initialOffset - frameDelta),
      );
