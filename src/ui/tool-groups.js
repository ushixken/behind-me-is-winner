(function(){
  ...
  function renderCameraOptions(body){
    ...
    const autoKeyRow=document.createElement('label');autoKeyRow.className='magic-wand-checkbox-row camera-auto-key-row';const autoKeyInput=document.createElement('input');autoKeyInput.type='checkbox';autoKeyInput.className='ts-check';autoKeyInput.checked=CameraSystem.autoKey;autoKeyInput.onchange=()=>CameraSystem.setAutoKey(autoKeyInput.checked);const autoKeyText=document.createElement('span');autoKeyText.textContent='Auto-Key';autoKeyRow.append(autoKeyInput,autoKeyText);transform.appendChild(autoKeyRow);
