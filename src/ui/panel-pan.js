...
(function () {
  ...
  document.addEventListener("pointerover", (e) => {
    ...
    if (
      hoverEl &&
      typeof spaceHeld !== "undefined" &&
      spaceHeld &&
      !(typeof ctrlHeld !== "undefined" && ctrlHeld) &&
      !panActive
    )
      setCursor(hoverEl, "grab");
  });
  ...
  document.addEventListener(
    ...
    (e) => {
      ...
      panStartX = e.clientX;
      panStartY = e.clientY;
      panStartScrollL = p.scrollLeft;
      panStartScrollT = p.scrollTop;
  ...
  function endPan() {
    if (panActive && panEl)
      setCursor(
        panEl,
        typeof spaceHeld !== "undefined" && spaceHeld ? "grab" : "",
      );
    panActive = false;
    panEl = null;
  }
