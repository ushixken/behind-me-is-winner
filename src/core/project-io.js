...
(function(){
  ...
  async function exportProject(){
    ...
    const manifest={format:FORMAT,version:VERSION,createdAt:new Date().toISOString(),document:{name:currentName(),width:CW,height:CH,totalFrames:TOTAL,maxFps:MAX_FPS,framesPerSecond:typeof getFPS==='function'?getFPS():Number(fpsTl.value)||PROJECT_DEFAULTS.fps,backgroundColor:bgColor,currentFrame:curFrame,currentLayer:curLayer,rangeStart,rangeEnd,loopRange:!!loopRange},groups:clone(groups||[]),layers:savedLayers,timeline:{frameLabelOffset:typeof frameLabelOffset==='number'?frameLabelOffset:0},palette:paletteState()};
